...
#
# Panoply — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: panoply-release)
...
CT_KEY_ID="${CT_KEY_ID:-panoply-release}"
...
echo "=== Panoply Cerro Torre Build Pipeline ==="
