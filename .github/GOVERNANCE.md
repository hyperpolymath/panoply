...
This document describes the governance model for **Panoply**.

---

## Project Governance Model

Panoply follows a **Benevolent Dictator For Life (BDFL)** governance model.
...
- ADRs provide a historical record of why decisions were made and what alternatives
  were considered.
- See `.machine_readable/descriptiles/META.deed` for the machine-readable ADR index.
