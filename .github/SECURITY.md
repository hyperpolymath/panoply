...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/panoply/security/advisories/new)
...
j.d.a.jewell@open.ac.uk. PGP-encrypted reports are not currently offered; please use
GitHub Security Advisories for end-to-end-encrypted disclosure.
...
- This repository (`hyperpolymath/panoply`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/panoply/security/advisories)
...
When using Panoply, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/panoply/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/panoply/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/panoply/discussions) |
...
*Thank you for helping keep Panoply and its users safe.* 🛡️
