...
= Contributing — Panoply
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Panoply`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Panoply.git
cd Panoply
...
* Bugs in `Panoply`: file at `hyperpolymath/Panoply/issues`.
