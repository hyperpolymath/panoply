...
# ladders declared in launcher/launcher-standard.deed §[resolution].
#
...
# hp_resolve_standard
#
#   Echoes the first existing launcher-standard.deed found via the
...
hp_resolve_standard() {
    local -a candidates=(
        ...
        "${HP_ESTATE_ROOT:+${HP_ESTATE_ROOT}/standards/launcher/launcher-standard.deed}"
        "${XDG_DATA_HOME:-${HOME}/.local/share}/hyperpolymath/standards/launcher/launcher-standard.deed"
        "/var/mnt/eclipse/repos/standards/launcher/launcher-standard.deed"
        "${HOME}/developer/repos/standards/launcher/launcher-standard.deed"
        "${HOME}/dev/repos/standards/launcher/launcher-standard.deed"
    )
