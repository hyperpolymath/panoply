...
- Missing or incomplete configuration files (SECURITY.md, CONTRIBUTING.md,
  .editorconfig, etc.)
- State files (STATE.deed, META.deed, ECOSYSTEM.deed) placed in the repository
...
- **Machine-readable state files** in `.machine_readable/` (STATE.deed,
  ECOSYSTEM.deed, META.deed, AGENTIC.deed, NEUROSYM.deed, PLAYBOOK.deed)
- **AI manifest** (`0-AI-MANIFEST.deed`) as a universal entry point for all
  AI agents
