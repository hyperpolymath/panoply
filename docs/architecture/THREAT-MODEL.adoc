...
Brief description of Panoply and its architecture.
...
| Secret rotation without record  | CI/CD secrets      | Low        | Low    | Low    | Secret rotation logged in STATE.deed           |
