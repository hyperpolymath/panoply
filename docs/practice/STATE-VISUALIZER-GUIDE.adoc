...
- **STATE.deed** — machine-readable state (tasks, blockers, next actions)
- **ECOSYSTEM.deed** — position in the wider project ecosystem
- **META.deed** — architecture decisions and design rationale
- **0-AI-MANIFEST.deed** — AI agent entry point and invariants
