...
TSDM is the operational core of the Rhodium Standard. Every task in the `Justfile` and every state change in `STATE.deed` should be justifiable within this framework.
