...
- `.machine_readable/policies/SOFTWARE-DEVELOPMENT-APPROACH.deed` (machine-readable)
...
- [ ] Keep machine-readable canonical structure under `.machine_readable/`:
  - state/meta/ecosystem files (`*.deed` or repo standard)
  - `anchors/ANCHOR.deed`
...
- [x] Machine-readable docs synchronized (`STATE.deed`, `META.deed`, `ECOSYSTEM.deed`, contractiles).
